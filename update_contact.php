      ...
      <div class="card-body">
        ...
        <form action="contact_update.php" method="post">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="leadName" name="name" placeholder="Enter full name" value="<?php echo htmlspecialchars($name); ?>" required>
          </div>
          <div class="form-group mb-3">
            <label for="leadPhone">Phone</label>
            <input type="tel" class="form-control" id="leadPhone" name="phone" placeholder="Enter phone number" value="<?php echo htmlspecialchars($phone); ?>" required>
          </div>
          <div class="form-group mb-3">
            <label for="leadEmail">Email</label>
            <input type="email" class="form-control" id="leadEmail" name="email" placeholder="Enter email address" value="<?php echo htmlspecialchars($email); ?>" required>
          </div>
          <div class="form-group mb-3">
            <label for="leadCompany">Company</label>
            <input type="text" class="form-control" id="leadCompany" name="company" value="<?php echo htmlspecialchars($company); ?>" placeholder="Enter company name">
          </div>
          <div class="form-group mb-3">
            <label for="leadCompany">City</label>
            <input type="text" class="form-control" id="leadCompany" name="city" value="<?php echo htmlspecialchars($city); ?>" placeholder="Enter city">
          </div>
