...
<html lang="en">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    <p class="card-title mb-0">Certificates</p>
    <a href="add_certificates.php" class="btn btn-primary btn-sm">+ Add Certificate</a>
  </div>
  ...
  <div class="row">
    ...
    if (mysqli_num_rows($result) > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        ?>
        <div class="col-md-4">
        <a href="allocate_certificate.php?id=<?php echo $row['id']; ?>" class="text-decoration-none text-dark">
            <div class="card border mb-4 shadow-sm">
            <img src="certificates/<?php echo htmlspecialchars($row['certificate_image']); ?>" class="card-img-top" alt="Certificate Image">
            <div class="card-body text-center">
                <h5 class="card-title mb-0"><?php echo htmlspecialchars($row['cource_name']); ?></h5>
            </div>
            </div>
        </a>
        </div>
      ...
      echo "<div class='col-12'><p>No certificates found.</p></div>";
    }
    ?>
  </div>
</div>
