...
if (isset($_GET['id'])) {
    ...
    // Fetch the lead data based on the ID
    ...
    // If no lead found with the given id
    if (!$lead) {
        die("Lead not found.");
    }
} else {
      ...
      <div class="card-body">
        ...
        <input type="hidden" name="id" value="<?php echo $lead['id']; ?>">
          ...
          <div class="form-group mb-4">
            ...
            <textarea class="form-control" id="followUp1" name="follow_up_1" placeholder="Enter Follow Up 1 details" rows="3"></textarea>
            </div>

            <div class="form-group mb-3">
            <label for="followUp2">Follow Up 2 </label>
            <textarea class="form-control" id="followUp2" name="follow_up_2" placeholder="Enter Follow Up 2 details" rows="3"></textarea>
            </div>

            <div class="form-group mb-3">
            <label for="followUp3">Follow Up 3 </label>
            <textarea class="form-control" id="followUp3" name="follow_up_3" placeholder="Enter Follow Up 3 details" rows="3"></textarea>
            </div>
