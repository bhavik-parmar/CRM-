            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                        <p class="card-title mb-0">Image Gallary</p>
                        <a href="add_img.php" class="btn btn-primary btn-sm">+ Add Image </a>
                    </div>
...
$query = "select * from photogallary";
  ...
  if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>"." <img src='gallary/" . htmlspecialchars($row['img']) . "' alt='Certificate' style='width: 150px; height: 100px; object-fit: cover; border: 1px solid #ccc; border-radius: 0;'>"."</td>";
        echo "</tr>";
    }
} else {
    echo "<tr><td colspan='9'>No Images Found.</td></tr>";
}
