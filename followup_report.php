              ...
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <p class="card-title mb-0">Follow_up</p>
                    </div>
...
$query = "
SELECT leads.id, leads.name, leads.email, leads.phone, leads.company, leads.source,
       followup.followup_1, followup.followup_2, followup.followup_3, followup.agree
FROM leads
...
";
  ...
  if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>" . htmlspecialchars($row['followup_1']) . "</td>";
        echo "<td>" . htmlspecialchars($row['followup_2']) . "</td>";
        echo "<td>" . htmlspecialchars($row['followup_3']) . "</td>";
        echo "<td>" . ($row['agree'] ) . "</td>";
        echo "<td>
                <a href='update_followup.php?id=" . $row['id'] . "' class='btn btn-sm btn-warning'><i class='mdi mdi-pencil'></i></a>
                <a href='delete_followup.php?id=" . $row['id'] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\");'><i class='mdi mdi-delete'></i></a>
              </td>";
        echo "</tr>";
    }
} else {
    echo "<tr><td colspan='9'>No leads or followups found.</td></tr>";
}
