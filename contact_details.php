            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="contact.php" class="btn btn-primary btn-sm">+ Add Contact</a>
                    </div>
...
$query = "select * from contact";
  ...
  if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>
                <a href='update_contact.php?id=" . $row['id'] . "' class='btn btn-sm btn-warning'><i class='mdi mdi-pencil'></i></a>
                <a href='delete_contact.php?id=" . $row['id'] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\");'><i class='mdi mdi-delete'></i></a>
              </td>";
        echo "</tr>";
    }
} else {
