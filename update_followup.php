...
$query = "SELECT leads.*, followup.followup_1, followup.followup_2, followup.followup_3, followup.agree 
          FROM leads 
          LEFT JOIN followup ON leads.id = followup.leads_id 
          WHERE leads.id = ?";
  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form action="update_follow_up.php" method="post">
        <input type="hidden" name="id" value="<?php echo $lead['id']; ?>">
          <div class="form-group mb-3">
            <label for="leadName">Name</label>
            <input type="text" class="form-control" id="leadName" name="name"  value="<?php echo $lead['name']; ?>"  placeholder="Enter full name" required>
          </div>
          <div class="form-group mb-3">
            <label for="leadPhone">Phone</label>
            <input type="tel" class="form-control" id="leadPhone" name="phone"  value="<?php echo $lead['phone']; ?>"  placeholder="Enter phone number" required>
          </div>
          <div class="form-group mb-3">
            <label for="leadEmail">Email</label>
            <input type="email" class="form-control" id="leadEmail" name="email"  value="<?php echo $lead['email']; ?>"  placeholder="Enter email address" required>
          </div>
          <div class="form-group mb-3">
            <label for="leadCompany">Company</label>
            <input type="text" class="form-control" id="leadCompany" name="company"  value="<?php echo $lead['company']; ?>"  placeholder="Enter company name">
          </div>
          <div class="form-group mb-4">
                                        ...
                                        <select class="form-control" id="leadSource" name="source">
                                            ...
                                            <option value="Social Media" <?php echo $lead['source'] == 'Social Media' ? 'selected' : ''; ?>>Social Media</option>
                                            <option value="Other" <?php echo $lead['source'] == 'Other' ? 'selected' : ''; ?>>Other</option>
                                        </select>
                                    </div>
                    <div class="form-group mb-3">
            <label for="followUp1">Follow Up 1 </label>
            <textarea class="form-control" id="followUp1" name="follow_up_1" rows="3"><?php echo $lead['followup_1']; ?></textarea>
            </div>

            <div class="form-group mb-3">
            <label for="followUp2">Follow Up 2 </label>
            <textarea class="form-control" id="followUp1" name="follow_up_2" rows="3"><?php echo $lead['followup_2']; ?></textarea>
            </div>

            <div class="form-group mb-3">
            <label for="followUp3">Follow Up 3 </label>
            <textarea class="form-control" id="followUp1" name="follow_up_3" rows="3"><?php echo $lead['followup_3']; ?></textarea>
            </div>

            <div class="form-group mb-4">
            <label for="agree">Agree to follow-up terms</label>
            <select class="form-control" id="agree" name="agree" required>
  <option value="" disabled>Select Yes or No</option>
  <option value="Yes" <?php echo ($lead['agree'] == 'Yes') ? 'selected' : ''; ?>>Yes</option>
  <option value="No" <?php echo ($lead['agree'] == 'No') ? 'selected' : ''; ?>>No</option>
</select>
