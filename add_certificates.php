      ...
      <div class="card-body">
        ...
        <form action="add_certificates.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3">
            ...
            <input type="file" class="form-control" id="leadCompany" name="certificate" placeholder="Add Cource Broucher">
          </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $certificate_folder = 'certificates/' . basename($certificate_name);

    // Check and move file
    if (move_uploaded_file($certificate_tmp, $certificate_folder)) {
        // Insert into database
        $sql = "INSERT INTO certificates (cource_name, certificate_image)
                VALUES ('$name',  '$certificate_name')";
        ...
        echo "<script>alert('Failed to upload certificate.'); window.history.back();</script>";
    }
