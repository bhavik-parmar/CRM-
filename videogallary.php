            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                        <p class="card-title mb-0">Video Gallary</p>
...
$query = "select * from videogallary";
  ...
  if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>";
        echo "<td>" . htmlspecialchars($row['video_name']) . "</td>";
        echo "<td><video src='gallary/" . htmlspecialchars($row['video']) . "' controls style='width: 150px; height: 100px; object-fit: cover; border: 1px solid #ccc; border-radius: 0;'></video></td>";
        echo "</tr>";
    }
} else {
    echo "<tr><td colspan='9'>No Video Found.</td></tr>";
}
