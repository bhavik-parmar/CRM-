              ...
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="add_cource.php" class="btn btn-primary btn-sm">+ Add Cource</a>
                    </div>
...
<tbody>
  ...
  $query = "SELECT * FROM cource ORDER BY id DESC";
  $result = mysqli_query($conn, $query);

  if (mysqli_num_rows($result) > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
          echo "<tr>";
          echo "<td>" . htmlspecialchars($row['cource_name']) . "</td>";
          echo "<td>" . htmlspecialchars($row['cource_title']) . "</td>";
          echo "<td>" . htmlspecialchars($row['date']) . "</td>";
          echo "<td>" . htmlspecialchars($row['duration']) . "</td>";
          echo "<td>" . htmlspecialchars($row['fees']) . "</td>";
          echo "<td>" . htmlspecialchars($row['broucher']) . "</td>";
          
          echo "</tr>";
      }
  } else {
      echo "<tr><td colspan='6'>No cource found.</td></tr>";
  }
