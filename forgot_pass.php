...
<body>
    <div class="container">
        <div class="login-container">
            ...
            <!-- Login Form -->
            <form id="loginForm" action="forgot_process.php" method="post" >
                <!-- Phone Number Field -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" name="npassword" id="password" placeholder="Enter New Password" required>
